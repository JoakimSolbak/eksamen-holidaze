...
const newEstablishmentBtn = document.getElementById('new-establishment-btn');
...
const newEstablishmentInterface = document.getElementById('new-establishment-interface');
